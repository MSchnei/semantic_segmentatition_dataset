...
#### Description: Perform fsl fast segmentation on unbiased images
#### To be set:
...
for (( i=0; i<${subjLen}; i++ )); do
  ...
  command+="-o ${parent_path}/derivatives/${subj}/segmentations/fast/${subj}_T1w_unbiased "
  command+="${parent_path}/derivatives/${subj}/bet/${subj}_T1w_unbiased_bet"
