...
for (( i=0; i<${subjLen}; i++ )); do
  ...
  mkdir -p "${analysis_path}/derivatives/${subj}/segmentations/T1wDivPD_segm"
  # specify segmentation comman
  command="/usr/share/fsl/5.0/bin/fast -t 1 -n 3 -H 0.1 -I 4 -l 20.0 "
  command+="-o ${analysis_path}/derivatives/${subj}/segmentations/T1wDivPD_segm/${subj}_T1wDivPD_unbiased_mas "
