#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Compare dropout rate in dense U-Net, trained iwth weighted loss."""
...
plt.ylabel("Loss")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/loss_dr_dense_weighted.svg")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/loss_dr_dense_weighted.png")
...
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/accuracy_dr_dense_weighted.svg")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/accuracy_dr_dense_weighted.png")
