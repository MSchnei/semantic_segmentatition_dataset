...
plt.ylabel("Loss")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/loss_dense.svg")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/loss_dense.png")
...
plt.xlabel("Number of Epochs")
plt.ylabel("Accuracy")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/accuracy_dense.svg")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/accuracy_dense.png")
