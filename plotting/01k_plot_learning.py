#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Compare BN (pre and post) vs no normalization in dense Unet (Tiramisu)."""
...
lst_prj = ['project34_32strides_maxpool_tranposed_dense_pre',
           ...
           'project41_32strides_maxpool_tranposed_dense_no_norm']
# list project names for plotting
lst_names = ['_Dense_BN_pre',
             '_Dense_BN_post',
             '_Dense_no_norm']
...
lst_evnt_trn = ['events.out.tfevents.1575050245.bi-node1.bi.3018.6516.v2',
                ...
                'events.out.tfevents.1575841991.bi-node1.bi.2064.2333.v2']
...
lst_evnt_val = ['events.out.tfevents.1575051067.bi-node1.bi.3018.58375.v2',
                ...
                'events.out.tfevents.1575842606.bi-node1.bi.2064.30631.v2']
...
plt.ylabel("Loss")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/loss_model_Dense_BN_nonorm.svg")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/loss_model_Dense_BN_nonorm.png")
...
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/accuracy_model_Dense_BN_nonorm.svg")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/accuracy_model_Dense_BN_nonorm.png")
