#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Compare BN (pre and post) vs no normalization in classic Unet."""
...
lst_prj = ['project32_32strides_maxpool_tranposed_classic_pre',
           ...
           'project40_32strides_maxpool_tranposed_classic_no_norm']
...
lst_evnt_trn = ['events.out.tfevents.1574986295.bi-node1.bi.427.2297.v2',
                ...
                'events.out.tfevents.1575813901.bi-node1.bi.1550.1051.v2']
...
lst_evnt_val = ['events.out.tfevents.1574987118.bi-node1.bi.427.31858.v2',
                ...
                'events.out.tfevents.1575814605.bi-node1.bi.1550.23796.v2']
...
plt.ylabel("Loss")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/loss_model_classic_BN_nonorm.svg")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/loss_model_classic_BN_nonorm.png")
...
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/accuracy_model_classic_BN_nonorm.svg")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/accuracy_model_classic_BN_nonorm.png")
