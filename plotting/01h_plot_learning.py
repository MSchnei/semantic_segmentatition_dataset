#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Compare LN vs BN and pre vs post activation in classic Unet."""
...
lst_prj = ['project32_32strides_maxpool_tranposed_classic_pre',
           ...
           'project36_32strides_maxpool_tranposed_classic_pre_LN',
           'project37_32strides_maxpool_tranposed_classic_post_LN']
# list project names for plotting
lst_names = ['_Classic_BN_pre',
             '_Classic_BN_post',
             '_Classic_LN_pre',
             '_Classic_LN_post']
...
lst_evnt_trn = ['events.out.tfevents.1574986295.bi-node1.bi.427.2297.v2',
                ...
                'events.out.tfevents.1575566434.bi-node1.bi.25426.1625.v2',
                'events.out.tfevents.1575600864.bi-node1.bi.26285.1625.v2']
...
lst_evnt_val = ['events.out.tfevents.1574987118.bi-node1.bi.427.31858.v2',
                ...
                'events.out.tfevents.1575567429.bi-node1.bi.25426.29690.v2',
                'events.out.tfevents.1575601713.bi-node1.bi.26285.29846.v2']
...
plt.ylabel("Loss")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/loss_model_classic_LN_BN.svg")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/loss_model_classic_LN_BN.png")
...
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/accuracy_model_classic_LN_BN.svg")
fig.savefig("/media/sf_D_DRIVE/Unet/presentation/results/plots/accuracy_model_classic_LN_BN.png")
